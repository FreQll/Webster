...
const Text = ({
  ...
  <div className="flex flex-col gap-3 border-b border-primary-grey-200 px-5 py-3">
    <h3 className="text-[12px] uppercase">Text</h3>
...
const RenderSelect = ({
  ...
  >
    <SelectTrigger className="bg-white no-ring w-full rounded-sm border border-primary-grey-200">
      <SelectValue
        placeholder={
          config.property === "fontFamily"
            ? "Choose a font"
    ...
    <SelectContent className=" bg-white border-primary-grey-200 text-primary-grey-300">
